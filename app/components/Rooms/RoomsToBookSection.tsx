...
export default function RoomsToBookSection() {
  return (
    <div>
      {" "}
      <div className="w-full grid grid-cols-2 gap-10 my-16 max-550:grid-cols-1">
        {roomsBook.map((e) => (
          <div
            key={e.id}
            className="max-w-[714px] w-full  flex flex-col  gap-5 max-1100:my-10 "
          >
            <div className="">
              <Image src={e.img} alt={e.title} width={714} height={429} />
            </div>

            <div className="flex flex-col  text-start gap-8  max-w-[550px] w-full ">
            ...
            <div className="flex flex-col mt-auto ">
              ...
              <div>
                <p className="font-normal text-[40px]">${e.price}<span className="text-xs font-normal mx-2">From / Per Night</span></p>
              </div>
            </div>
            </div>
          </div>
