...
export default function MakrineMenu() {
  ...
  return (
    <div className="max-w-[1250px] w-full m-auto flex flex-col justify-center items-center text-center text-secondaryTextColor -my-14">
      <div className="max-w-[500px] w-full flex flex-col justify-center items-center text-center text-secondaryTextColor font-mono-serif  max-400:gap-3">
        {/* <Image
          priority={true}
