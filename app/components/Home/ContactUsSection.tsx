...
export default function ContactUsSection() {
  return (
    <div className="max-w-[980px] w-full m-auto bg-ilialake min-h-[990px] mt-96 flex flex-col items-center justify-center text-center text-secondaryTextColor max-700:bg-center bg-cover  max-1100:mt-0 max-700:mt-24 max-450:mt-0">
      <div className="flex flex-col gap-4 max-400:gap-2">
        <h2 className="font-semibold text-[40px] max-450:text-[32px]">Further Questions</h2>
