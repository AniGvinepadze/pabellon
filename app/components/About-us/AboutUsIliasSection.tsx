...
//         moment that reflects the essence of our brand and its connection to
//         Georgian heritage and literature. And Makrine, Aunt - who raised him
//         as her own child, is someone who values family, tradition and
//         sharing a delicious meal in a beautiful setting. We promise a warm
//         and nurturing dining experience, inspired by Makrine's legacy, where
//         you can taste delicious food and create lasting memories with loved
//         ones. Farm to table movement highlights the importance of
//         nutritional value and community engagement. In addition of the true
//         agricultural concept, it is a luxurious destination where comfort,
//         style and unforgettable experiences meet.
//       </p>
//       <div className="flex justify-center">
//         <Image src={inscription} alt="ilialake" width={660} height={178} />
//       </div>
